...
public final class ExceptionDetails {
     ...
     * @return the ExceptionDetails object itself.
     */
    public ExceptionDetails setId(Integer id) {
        this.id = id;
        return this;
    }
     ...
     * @return the ExceptionDetails object itself.
     */
    public ExceptionDetails setOuterId(Integer outerId) {
     ...
     * @return the ExceptionDetails object itself.
     */
    public ExceptionDetails setHasFullStack(Boolean hasFullStack) {
     ...
     * @return the ExceptionDetails object itself.
     */
    public ExceptionDetails setStack(String stack) {
        this.stack = stack;
        return this;
    }
     ...
     * @return the ExceptionDetails object itself.
     */
    public ExceptionDetails setParsedStack(List<StackFrame> parsedStack) {
